...
![RNA-seq end-to-end workflow — from RNA extraction through pathway analysis](/blog/rnaseq-workflow.svg)
...
![Splice-aware alignment — how reads span exon–intron boundaries](/blog/splice-alignment.svg)
...
![Volcano plot — upregulated genes (teal, right) and downregulated genes (purple, left) against non-significant hits (grey)](/blog/volcano-plot.svg)

![PCA plot — samples should cluster by biological group; outliers warrant investigation before exclusion](/blog/pca-plot.svg)
